...
Nova.booting(function (Vue, router, store) {
  Vue.component('exchange-rate', __webpack_require__(2));
});
    ...
    [
      _c("div", { staticClass: "px-12 py-12" }, [
        ...
        _c("table", [
          ...
          _c("tbody", [
            _c("tr", [
              _c("td", [_vm._v(_vm._s(_vm.rate.USD))]),
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(_vm.rate.GBP))]),
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(_vm.rate.EUR))])
            ])
          ])
        ])
      ])
